...
export default async function AdminProductionPage() {
  ...
  const { data: orders } = await supabase
    .from('orders')
    .select('id, order_number, customer_name, customer_phone, wilaya_code, commune, address, confirmed_at, updated_at, status, sent_to_partner_at, total_dzd, order_items(id, product_name, size, quantity, garment_color, qr_preset, text_content, logo_choice, logo_position)')
